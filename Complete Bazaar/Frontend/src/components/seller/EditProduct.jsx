                ...
                >
                    ...
                    <div className="flex gap-4">
                        <button
                            type="button"
                            onClick={() => navigate("/")}
                            className="w-full py-3 px-6 rounded-lg border border-slate-600 text-slate-300 hover:text-white hover:border-indigo-500/50 hover:bg-indigo-500/10 font-semibold text-lg transition-all duration-200 cursor-pointer"
                        >
                            Cancel
                        </button>
                        <button
