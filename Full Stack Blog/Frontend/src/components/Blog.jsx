    ...
    <div className="w-full bg-white rounded-xl shadow-lg overflow-hidden my-8 border border-slate-200">
      ...
      <div className="px-6 pb-4">
        ...
        <div className="flex items-center gap-4 mb-4">
          <button className="flex items-center px-4 py-1 bg-blue-100 text-blue-700 font-semibold rounded-lg hover:bg-blue-200 transition">
            👍 Like <span className="ml-2">{blog.likes}</span>
          </button>
          <button className="flex items-center px-4 py-1 bg-red-100 text-red-700 font-semibold rounded-lg hover:bg-red-200 transition">
            🗑 Delete
          </button>
        </div>
      </div>
